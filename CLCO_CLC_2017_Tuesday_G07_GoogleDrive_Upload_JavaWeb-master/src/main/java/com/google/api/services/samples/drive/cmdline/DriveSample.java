...
public class DriveSample {
  ...
  private static final String UPLOAD_FILE_PATH = "C:/Users/vuonx/Downloads/chuong 7.pptx";
  private static final String DIR_FOR_DOWNLOADS = "F:/DriveTest";
  ...
  public static void excuteUploadFile(String UPLOAD_FILE_PATH) throws Exception{
	  ...
	  Preconditions.checkArgument(
		    ...
		    try {
		      ...
		      File uploadedFile = uploadFile1(false, UPLOAD_FILE);
   
		      File updatedFile = updateFileWithTestSuffix(uploadedFile.getId());

		      uploadedFile = uploadFile1(true, UPLOAD_FILE);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      File uploadedFile = uploadFile0(false);
  ...
  private static File uploadFile1(boolean useDirectUpload, java.io.File UPLOAD_FILE) throws IOException {
	    File fileMetadata = new File();
	    fileMetadata.setTitle(UPLOAD_FILE.getName());
  ...
  private static File uploadFile0(boolean useDirectUpload) throws IOException {
	    File fileMetadata = new File();
	    fileMetadata.setTitle(UPLOAD_FILE.getName());
